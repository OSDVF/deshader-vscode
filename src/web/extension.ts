...
export function activate(context: vscode.ExtensionContext) {
	...
	const changeCallback = vscode.debug.onDidChangeActiveStackItem ?? (<any>vscode.debug).onDidChangeStackFrameFocus
	...
	if (typeof changeCallback !== 'undefined')
		context.subscriptions.push(changeCallback(async (e) => {
